...
describe("ResultsTable", () => {
  ...
  test("displays correct count for single address", () => {
  ...
  test("displays correct count for multiple addresses", () => {
    const { container } = render(<ResultsTable results={mockResults} />);
  ...
  test("renders map links for each result", () => {
    const { container } = render(<ResultsTable results={mockResults} />);
  ...
  test("map links have correct href format", () => {
    const { container } = render(<ResultsTable results={[mockResults[0]!]} />);
  ...
  test("map links open in new tab", () => {
    const { container } = render(<ResultsTable results={[mockResults[0]!]} />);
  ...
  test("renders map icon for each result", () => {
    const { container } = render(<ResultsTable results={mockResults} />);
  ...
  test("encodes special characters in map URL", () => {
    const specialResult = [
      {
  ...
  test("generates unique keys for rows", () => {
  ...
  test("renders all address data correctly", () => {
    const { container } = render(<ResultsTable results={mockResults} />);
